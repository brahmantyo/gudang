				...
				<table class="table">
					...
					<tbody>
						...
						<tr style="background-color: #78f6ff;">
							...
							<td>
								<?php $state = $t->stat>0?'disabled':'';?>
								<a href="?url=kemasan/send/<?php echo $t->ref_number;?>/masuk" class="btn btn-sm btn-success <?php echo $state;?>" >SEND</a>
								<a href="?url=kemasan/view/<?php echo $t->ref_number;?>/masuk" class="btn btn-sm btn-info" >View Detail</a>
							</td>
						</tr>
						<?php
									}
						...
						<tr style="background-color: #78baff;">
							...
							<td>
								<?php $state = $t->stat>0?'disabled':'';?>
								<a href="?url=kemasan/send/<?php echo $t->ref_number;?>/keluar" class="btn btn-sm btn-success <?php echo $state;?>" >SEND</a>
								<a href="?url=kemasan/view/<?php echo $t->ref_number;?>/keluar" class="btn btn-sm btn-info" >View Detail</a>
							</td>
						</tr>
						<?php
									}
