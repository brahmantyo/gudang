				...
				<ul class="nav navbar-nav">
					...
					<li class="nav-item">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo SITE_ROOT;?>?url=kemasan/masuk">Report Barang Masuk</a></li>
							<li><a href="<?php echo SITE_ROOT;?>?url=kemasan/keluar">Report Barang Keluar</a></li>
							<li class="divider"></li>
							<li><a href="<?php echo SITE_ROOT;?>?url=kemasan/daftar">Daftar Report</a></li>
						</ul>
					</li>
					<li class="nav-item active">
						<a href="<?php echo SITE_ROOT;?>?url=kemasan/cari" class="nav-link">Pencarian</a>
					</li>
				</ul>
