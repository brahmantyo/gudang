								...
								<tbody>
									<tr>
										...
										<td>
											...
											<input tabindex="1" type="text" name="kd_dok" class="form-control" value="6" disabled>
										</td>
									</tr>
									<tr>
										<td>KD_TPS</td>
			        ...
			        <div id="collapse2" class="panel-body panel-collapse collapse">
							<div class="col-md-12">
								<table class="table table-responsive table-condensed">
									...
									<tbody>
										<tr>
											<td><input class="form-control" type="text" name="no_bl_awb" value="<?php echo $data['no_bl_awb'];?>" ></td>
											<td><input class="form-control" type="date" name="tgl_bl_awb" value="<?php echo $data['tgl_bl_awb'];?>" ></td>
											<td><input class="form-control " type="text" name="no_master_bl_awb" value="<?php echo $data['no_master_bl_awb'];?>" ></td>
											<td><input class="form-control" type="date" name="tgl_master_bl_awb" value="<?php echo $data['tgl_master_bl_awb'];?>" ></td>
											<td><input class="form-control" type="text" name="id_consignee" value="<?php echo $data['id_consignee'];?>" ></td>
										</tr>
									</tbody>
								</table>
								<table class="table table-responsive table-condensed">
									...
									<tbody>
										<tr>
											<td><input class="form-control" type="text" name="consignee" value="<?php echo $data['consignee'];?>" ></td>
											<td><input class="form-control" type="text" name="bruto" value="<?php echo $data['bruto'];?>" ></td>
											<td><input class="form-control" type="text" name="no_bc11" value="<?php echo $data['no_bc11'];?>" ></td>
											<td><input class="form-control" type="date" name="tgl_bc11" value="<?php echo $data['tgl_bc11'];?>" ></td>
											<td><input class="form-control" type="text" name="no_pos_bc11" value="<?php echo $data['no_pos_bc11'];?>" ></td>
										</tr>
									</tbody>
								</table>
								<table class="table table-responsive table-condensed">
									...
									<tbody>
										<tr>
											<td><input class="form-control" type="text" name="cont_asal" value="<?php echo $data['cont_asal'];?>" ></td>
											<td><input class="form-control" type="text" name="seri_kemas" value="<?php echo $data['seri_kemas'];?>" ></td>
											<td><input class="form-control" type="text" name="kd_kemas" value="<?php echo $data['kd_kemas'];?>" ></td>
											<td><input class="form-control" type="text" name="jml_kemas" value="<?php echo $data['jml_kemas'];?>" ></td>
											<td><input class="form-control" type="text" name="kd_timbun" value="<?php echo $data['kd_timbun'];?>" ></td>
										</tr>
									</tbody>
								</table>
							</div>
